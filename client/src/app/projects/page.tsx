        ...
        <main className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-6xl">
          ...
          {loading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-slate-100 dark:bg-slate-150 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 animate-pulse p-4 sm:p-6 space-y-3">
