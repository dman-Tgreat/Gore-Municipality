  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans flex flex-col justify-between">
      <div>
        ...
        <section className="bg-gradient-to-br from-green-800 via-green-700 to-emerald-800 text-white py-14 text-center">
          <div className="container mx-auto px-6">
            ...
            <p className="mt-2 text-green-100 max-w-xl mx-auto text-sm">{t.servicesPage.subtitle}</p>
          </div>
        </section>
              ...
              {departments.map((dept, idx) => {
                ...
                return (
                  <Link
                    ...
                    className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-200 hover:-translate-y-1 group block"
                  >
                    <div className={`p-6 bg-gradient-to-r ${gradient} bg-opacity-10 border-b border-gray-100 flex items-center space-x-3`}>
                      ...
                      <div className="text-white">
                        ...
                        <p className="text-xs text-white/80">{dept.head}</p>
                      </div>
                    </div>
                    <div className="p-6 space-y-3">
                      <p className="text-sm text-gray-600 leading-relaxed line-clamp-3">{dept.description}</p>
