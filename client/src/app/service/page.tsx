                ...
                >
                  <div className="p-6 bg-slate-100 dark:bg-slate-700 border-b border-slate-200 dark:border-slate-600 flex items-center space-x-3">
                    ...
                    <div className="text-slate-900 dark:text-slate-100">
                      ...
                      <p className="text-base text-slate-700 dark:text-slate-300">{dept.head}</p>
                    </div>
                  </div>
                  <div className="p-6 space-y-3">
                    <p className="text-base text-slate-600 dark:text-slate-300 leading-relaxed line-clamp-3">{tField(dept, 'description', locale)}</p>
                    <div className="text-xs text-slate-600 dark:text-slate-400 space-y-1.5 pt-3 border-t border-slate-200 dark:border-slate-700">
                      {dept.phone && <p className="flex items-center gap-1.5 text-base text-slate-600 dark:text-slate-300"><Phone className="w-3.5 h-3.5 text-slate-500 dark:text-slate-400" /> {dept.phone}</p>}
                      {dept.email && <p className="flex items-center gap-1.5 text-base text-slate-600 dark:text-slate-300"><Mail className="w-3.5 h-3.5 text-slate-500 dark:text-slate-400" /> {dept.email}</p>}
                      {dept.office && <p className="flex items-center gap-1.5 text-base text-slate-600 dark:text-slate-300"><MapPin className="w-3.5 h-3.5 text-slate-500 dark:text-slate-400" /> {dept.office}</p>}
                    </div>
                    <div className="pt-2">
