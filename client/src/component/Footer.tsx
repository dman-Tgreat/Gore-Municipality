            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-slate-300 dark:text-slate-500 hover:text-gold-light text-base transition-colors inline-flex items-center gap-2"
                  >
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-300 dark:text-slate-500 text-base leading-relaxed">{address}</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <span className="text-slate-300 dark:text-slate-500 text-base">{phone}</span>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-gold shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                </svg>
                <a href={`mailto:${email}`} className="text-slate-300 dark:text-slate-500 hover:text-gold-light text-base transition-colors">{email}</a>
              </li>
            </ul>
          </div>
